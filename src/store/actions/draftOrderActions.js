...
export const loadDraftGoaliesOrder = () => {
    // return (dispatch, getState, {getFirebase, getFirestore}) => {
    //     const firestore = getFirestore();
    //     // players.forEach(player=>{
    //         firestore.collection("draftOrder").doc("goalieDraftOrder").get()
    //         .then((draftorder) => {
    //             console.log(draftorder.data())
    //             dispatch(
    //                 { 
    //                     type: "GET_GOALIE_DRAFT_ORDER_FROM_DB",
    //                     order: draftorder.data().goaliedraftorder
    //                 })
    //             })
